package ru.otus.spring_2020_11.hw17.changelogs;
...
import ru.otus.spring_2020_11.hw17.repostitory.AuthorRepository;
import ru.otus.spring_2020_11.hw17.repostitory.BookRepository;
import ru.otus.spring_2020_11.hw17.security.dao.UserRepository;
import ru.otus.spring_2020_11.hw17.security.dto.UserDb;
...
public class InitMongoDbChangelog {
    ...
    public void initUser(UserRepository repository) {
        repository.save(new UserDb("user", BCrypt.hashpw("pass", BCrypt.gensalt()), "ROLE_USER"));
        repository.save(new UserDb("editor", BCrypt.hashpw("pass", BCrypt.gensalt()), "ROLE_EDITOR"));
    }
}
