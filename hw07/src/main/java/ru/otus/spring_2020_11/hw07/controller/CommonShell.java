package ru.otus.spring_2020_11.hw07.controller;
...
import ru.otus.spring_2020_11.hw07.dao.AuthorDao;
import ru.otus.spring_2020_11.hw07.dao.BookDao;
import ru.otus.spring_2020_11.hw07.dao.CommentaryDao;
import ru.otus.spring_2020_11.hw07.dao.GenreDao;
...
public class CommonShell {
    ...
    public String insertBook(@ShellOption String title, @ShellOption long authorId, @ShellOption long genreid) {
        val author = authorDao.findById(authorId).get();
        val genre = genreDao.findById(genreid).get();
    ...
    public String insertCommentary(@ShellOption long bookId, @ShellOption String message) {
        val book = bookDao.findById(bookId).get();
